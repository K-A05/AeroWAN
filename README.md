# AeroWAN
Aerowan is a combination of two distinct networking technologies: the [reticulum network](https://reticulum.network/) and the [iroh](https://www.iroh.computer/) networking stack which allows for modular, peer to peer connections between devices.
